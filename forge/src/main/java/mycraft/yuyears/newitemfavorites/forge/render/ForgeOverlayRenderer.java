package mycraft.yuyears.newitemfavorites.forge.render;
...
import mycraft.yuyears.newitemfavorites.forge.NewItemFavoritesForge;
...
public class ForgeOverlayRenderer extends OverlayRenderer {
    ...
    private void renderContainerScreenOverlays(AbstractContainerScreen<?> screen, GuiGraphics context) {
        boolean isHoldingBypassKey = NewItemFavoritesForge.isBypassKeyHeld();
